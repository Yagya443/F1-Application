  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row">
        {/* Image */}
        <div className="relative sm:w-52 lg:w-64 flex-shrink-0 overflow-hidden" style={{ minHeight: '160px' }}>
          <img
            src={race.imageUrl}
            alt={race.name}
        ...
        <div className="flex-1 p-5 sm:p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-500 text-sm mb-4">{race.circuit}</p>
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[#1A1A1A] border border-[#252525]">
                  ...
                  <div>
                    <div className="text-xs text-gray-500 uppercase tracking-wider leading-none mb-0.5">Winner</div>
                    <div className="text-white text-sm font-semibold leading-none">{race.winner}</div>
                  </div>
            ...
            <div className="flex-shrink-0 text-right">
              <div className="mb-4">
                <div className="text-gray-500 text-xs uppercase tracking-wider mb-1">Fastest Lap</div>
                <div className="text-white text-sm font-mono font-semibold flex items-center gap-1 justify-end">
                  <Clock size={12} className="text-[#E10600]" />
                  {race.fastestLap}
                </div>
              </div>
              ...
              >
                Results
                <ChevronRight size={14} className={`transition-transform duration-200 ${hovered ? 'translate-x-1' : ''}`} />
              </button>
            </div>
          </div>
        </div>
  ...
  return (
    <section className="py-20 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12">
          <span className="section-label block mb-3">Race Results</span>
